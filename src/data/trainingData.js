export const trainingData = {
  ...
  'compassionate-leadership-development-programme': {
    ...
    expectations: [
      {
        title: 'A flexible format',
        description: 'Choose from a one-day participatory workshop or a series of sessions scheduled with your company\'s availability. Designed for leaders at all levels.'
      },
      {
        title: 'Learning and doing',
        description: 'You will experience a dynamic blend of theory and interactive practice in a collaborative group setting, complemented by one-to-one coaching.'
      },
      {
        title: 'Tailored modules',
        description: 'Our topics include: building trust, presenting with authenticity, resilience and wellbeing, mentoring and employee development, and conflict resolution. Each Leadership Development Programme is bespoke to the needs of your group, ensuring your learning experience is relevant and deeply impactful.'
      }
    ],
    outcomes: [
      'Refined management approaches, enhanced communication and presentation skills and the ability to masterfully handle conflicts and challenges at work.',
      'An elevated sense of camaraderie with fellow leaders, having shared a poignant and transformational learning journey.',
      'A healthier, happier relationship with your team, fostering a more cohesive and productive work environment.'
    ],
    cta: 'Leadership isn\'t just about facts and figures – it\'s about people. Are you ready to lead with compassion and confidence? Get in touch via georgie@globaltraining.uk today.'
  },
  'team-away-days': {
    ...
    description: 'The popular hybrid model has plenty of perks: flexibility, freedom and fewer commutes. However, many employees feel disconnected, spending the vast majority of their working week facing a screen, rather than each other. A bespoke Global away day could be just what your team needs: a face-to-face reset that helps team members reconnect both professionally and personally. It\'s also a chance to rediscover purpose - to remember why they do what they do, and why it matters.',
    expectations: [
      {
        title: '100% bespoke',
        description: 'We tailor our away days to you and your team, aligning with your company\'s ethos, values and specific needs.'
      },
      {
        title: 'Picturesque locations',
        description: 'Whilst we will always offer to come to you, we love to transport teams to beautiful locations across the UK - putting the \'outdoors\' into the \'out of office\'.'
      },
      {
        title: 'Creative team building',
        description: 'We lead a range of collaborative activities throughout the day, encouraging teamwork, playfulness and self discovery.'
      }
    ],
    outcomes: [
  ...
  'creative-conflict-resolution': {
    ...
    subtitle: 'Focused sessions to help participants develop self-awareness, empathy, and better communication skills',
    intro: '',
    description: 'Creative Conflict Resolution training helps teams transform workplace conflicts into opportunities for growth and innovation.',
    expectations: [],
    outcomes: [],
  ...
  'coaching': {
    title: 'Coaching',
    subtitle: 'Qualified coaches → team of Philosophical Life Compass coaches',
    intro: '',
    description: 'Decision-making coaching; leaders in an organisation needing a reset, individuals undergoing life transition, targeting professional and personal resets, one-to-one & retreats. Match an individual coach to a person.',
    expectations: [
      {
        title: 'Philosophical Life Compass',
        description: 'Two-session approach, and an optional follow-up.'
      },
      {
        title: 'Retreats',
        description: 'Mothers "mothering Sunday", people going through grief/heartbreak, Retired/near retirement, Career change'
      }
    ],
    outcomes: [
      'A unique opportunity to develop your repertoire by training as a Philosophical Life Compass Coach with Global Training.',
      'The Philosophical Life Compass is a valuable tool for coaches, psychologists, teachers and others to help clients make effective decisions about life, relationships, career and jobs, health choices and place to live, based upon one\'s deep spiritual and philosophical values.',
      'This course, delivered over two days will immerse you into a coaching framework which is used as a tool to support people to connect with their core values and reduce external noise, bias and distraction.'
    ],
    cta: 'Learn more at https://thelifecompass.co.uk/'
  },
  'foundation-mediation-course': {
    title: 'Foundation Mediation Course',
    subtitle: 'Focused sessions to help participants develop self-awareness, empathy, and better communication skills',
    intro: 'The world needs peacemakers, now more than ever. Could this be you? Do you want to make a positive, lasting difference in people\'s lives? Have you considered a fulfilling career change that aligns with your passions and values?',
    description: 'Global Mediation was established in 1999 and is recognised as the leading mediation provider in the UK. Our Foundation Mediation course delivers meaningful and dynamic practice-based training, grounded in current research and legislation. This six-day programme is designed for professionals entering the field of mediation, and is inclusive and accessible for all. You will be in the safe hands of our dedicated mediators and trainers, who will guide you through the mediation process with various practical, interactive, and engaging approaches.',
    expectations: [
      {
  ...
  'send-mediation-course': {
    ...
    subtitle: 'Focused sessions to help participants develop self-awareness, empathy, and better communication skills',
    intro: 'Are you a qualified mediator looking to broaden your horizons? Do you want to truly make a difference with your work, transforming the lives of young people with special educational needs and disabilities?',
    description: 'There is an ever-increasing demand for SEND mediators in the sector, with thousands of cases each year - including a wealth of remote work. At Global, we provide specialist SEND training complete with a comprehensive observation programme - featuring mentoring, co-mediations, and hands-on case experience - giving you a 360-degree learning journey.',
    expectations: [
      {
    ...
    outcomes: [
      'Once you\'ve qualified as a SEND mediator with us, you will be fully equipped with knowledge, skills, observation, and practice experience to get started in this rich and fulfilling sector.'
    ],
    cta: 'Get in touch via georgie@globaltraining.uk to book your place on our next course - the momentous first step toward changing lives.'
  },
