...
const page = () => {
  return (
    <div>
      <header className="pt-[187px]  relative md:pt-[138px] pb-[176px] md:pb-[53px]">
        <Marquee speed={15} autoFill>
          <div className=" rounded-3xl overflow-hidden w-[230px] h-12 mx-[10px] lg:h-[286px]  ">
            <Image className="w-full h-full object-cover object-center" src={img2} alt="Living Wadge Company" />
          </div>
          <div className="mt-[100px] rounded-3xl overflow-hidden w-[230px] h-12 mx-[10px] lg:h-[286px]  ">
