...
const page = () => {
  return (
    <div>
      <header
        style={{
          backgroundImage: `url('/image 17.png'), linear-gradient(to right, #350b50 0%, rgba(62, 0, 101, 0.20) 100%)`,
      ...
      >
        <div className="w-full relative z-10 lg:max-w-[80%]">
          <h1 className="font-semibold tracking-[-4%] leading-[120%] text-5xl md:[65px] lg:text-[68px] text-white">Get in Touch</h1>
          <p className="text-white mt-[18px] md:mt-6 mb-[26px] md:mb-8 w-[70%] font-normal text-sm md:text-lg">
            We’d love to help you transform your team.
          </p>
        </div>
      </header>
