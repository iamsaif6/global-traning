  ...
  return (
    <section className="px-4 bg-primary py-[80px] lg:py-[100px]  lg:px-[80px]">
      ...
      <div className="max-w-[1130px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10 lg:mt-[80px]">
        <div className=" rounded-3xl flex items-center bg-white p-6 min-h-[200px] lg:min-h-[300px]">
          <div>
        ...
        <div className=" rounded-3xl flex items-center bg-white p-6 min-h-[200px] lg:min-h-[300px]">
          <div>
            <div className="mb-5 flex items-center gap-3">
              ...
              <p className="text-[#511A75] font-medium text-[18px] lg:text-[22px] leading-[120%] ">
        ...
        <div className="flex items-center rounded-3xl bg-white p-6 min-h-[200px] lg:min-h-[300px]">
          <div>
            <div className="mb-5 flex items-center gap-3">
              <div className="w-12 flex-shrink-0 text-secondary text-3xl font-semibold flex items-center justify-center lg:w-[60px]  h-12 lg:h-[60px] bg-[#511A7533] rounded-lg">
                {/* <Gift /> */}5
