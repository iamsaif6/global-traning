...
const Header = () => {
  return (
    <header
      style={{
        backgroundImage: ` linear-gradient(to bottom, rgba(62, 0, 101, 0.90) 15.68%, rgba(62, 0, 101, 0.01) 69.4%)`,
    ...
    >
      <div className="w-full relative z-10 lg:max-w-[80%] mx-auto text-center">
        <h1 className="font-medium tracking-[-4%] leading-[120%] text-5xl md:[65px] lg:text-[84px] text-white">
          Empowering people to grow, connect and lead with confidence
        </h1>
        <p className="text-white text-center mx-auto mt-[18px] md:mt-6 mb-[26px] md:mb-8 w-[70%] font-normal text-sm md:text-lg">
