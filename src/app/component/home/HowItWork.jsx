...
const HowItWork = () => {
  return (
    <section className="pt-[120px] pb-[160px] px-[100px] bg-primary">
      <SectionTitle
        badge={'HOW IT WORKS'}
      ...
      <div className="grid mt-[60px] grid-cols-2 gap-5">
        ...
        <div className="space-y-6">
          <div className="bg-white shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.10),_0px_10px_10px_-5px_rgba(0,0,0,0.04)] duration-200 hover:bg-[linear-gradient(to_bottom,_rgba(62,0,101,0.50)_15.68%,_rgba(62,0,101,0.01)_69.4%)]  flex gap-6 p-6 rounded-3xl">
            ...
            <div className="">
              <h4 className="text-[28px] font-medium mb-3  text-[#18181B]">Book a Discovery Call</h4>
          ...
          <div className="bg-white shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.10),_0px_10px_10px_-5px_rgba(0,0,0,0.04)] duration-200 hover:bg-[linear-gradient(to_bottom,_rgba(62,0,101,0.50)_15.68%,_rgba(62,0,101,0.01)_69.4%)]  flex gap-6 p-6 rounded-3xl">
            <div className=" duration-200 bg-secondary text-white group-hover:text-secondary w-[40px] h-[40px] flex-shrink-0 rounded-[8px] flex items-center justify-center font-medium text-[28px]">
              2
            </div>
            <div className="">
              <h4 className="text-[28px] font-medium mb-3  text-[#18181B]">Tailor Your Training Experience</h4>
              <p className="text-lg leading-[140%]  text-[#6E7381]">
          ...
          <div className="bg-white shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.10),_0px_10px_10px_-5px_rgba(0,0,0,0.04)] duration-200 hover:bg-[linear-gradient(to_bottom,_rgba(62,0,101,0.50)_15.68%,_rgba(62,0,101,0.01)_69.4%)]  flex gap-6 p-6 rounded-3xl">
            ...
            <div className="">
              <h4 className="text-[28px] font-medium mb-3  text-[#18181B]">Empower Your People to Grow</h4>
              <p className="text-lg leading-[140%]  text-[#6E7381]">
