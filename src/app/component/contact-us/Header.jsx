...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid text-black mt-10 mb-10  grid-cols-3 gap-10  px-5 md:px-16 md:pb-[20px] ">
        ...
        <div className="col-span-3 lg:col-span-1 flex gap-5 items-center">
          <Check className="text-secondary flex-shrink-0" />
          <p className=" font-normal text-[15px]">
            <strong> Trusted by Thousands</strong> . We’ve helped resolve over 20,000 disputes across the UK — from families and businesses
