      ...
      <div>
        <div className={`w-full text-white  lg:max-w-[660px]`}>
          ...
          <div className=" mt-[60px]">
            <p className="mb-5 text-base lg:text-lg text-white font-medium">Our programmes deliver tangible change:</p>
            ...
            <p className="mt-5 text-base lg:text-lg text-white font-medium">Because when growth feels real, it creates real results.</p>
          </div>
        </div>
      </div>
