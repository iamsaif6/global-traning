...
const AboutUS = () => {
  return (
    <div>
      <header
        style={{
          backgroundImage: `linear-gradient(to right, rgba(62, 0, 101, 0.90) 15.68%, rgba(62, 0, 101, 0.31) 69.4%, rgba(255, 255, 255, 1) 100%)`,
      ...
      >
        <div className="w-full relative z-10 lg:max-w-[80%]">
          ...
          <p className="text-white mt-[18px] md:mt-6 mb-[26px] md:mb-8 w-[70%] font-normal text-sm md:text-lg">About Global Training</p>
        </div>
      </header>
      <WhoWeAre />
      {/* Logo Item */}
