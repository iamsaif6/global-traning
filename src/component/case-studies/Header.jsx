  ...
  return (
    <header>
      <header
        ...
        className="pt-[137px] borer grid lg:gap-[50px] grid-cols-12 relative md:pt-[180px] gap-y-12 lg:gap-y-0  md:pb-[0px] px-5 md:px-[60px] items-center"
      >
        <div className="order-2 lg:order-1 col-span-12 lg:col-span-4  ">
